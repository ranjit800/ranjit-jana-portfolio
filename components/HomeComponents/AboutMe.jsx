    ...
    <section  className="bg-black text-white py-16 min-h-screen">
      <div className="container mx-auto px-6 flex flex-col-reverse md:flex-row items-center gap-12">
        ...
        <div  className="md:w-1/2 text-center md:text-left">
          <h2 className="hidden md:block text-4xl font-bold mb-4 bg-gradient-to-r from-blue-400 to-pink-400  text-transparent bg-clip-text">
            About Me
          </h2>
        ...
        <h2 className="block md:hidden text-4xl font-bold mb-4 bg-gradient-to-r from-blue-400 to-pink-400  text-transparent bg-clip-text">
            About Me
          </h2>
          ...
          <div className="absolute md:top-0 md:right-5 top-10 right-5 animate-spin-slow-reverse">
          ...
          <div className="absolute md:top-1/2 md:right-0 top-60 right-5 animate-spin-slow">
...
{/* Hire Me Badge */}
          <div className="absolute md:bottom-1/2 md:left-0 bottom-48 left-2 animate-spin-slow">
